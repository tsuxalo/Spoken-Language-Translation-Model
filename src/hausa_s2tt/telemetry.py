...
class RuntimeTimer:
    ...
    def measurement(self, examples: int, audio_seconds: float) -> RuntimeMeasurement:
        ...
        return RuntimeMeasurement(self.wall_seconds, examples, audio_seconds, gpu_count, peak)
...
def estimate_full_run(
    ...
    *,
    ...
    return {
        ...
        "projected_checkpoint_storage_bytes": checkpoint_bytes_per_save * expected_saves,
